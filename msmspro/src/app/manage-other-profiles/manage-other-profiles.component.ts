...
@Component({
  selector: 'app-manage-other-profiles',
  templateUrl: './manage-other-profiles.component.html',
  styleUrls: ['./manage-other-profiles.component.css']
})
export class ManageOtherProfilesComponent {
  EmpList: Employee[]=[];
  page:number=1;
  count:number=0;
  tableSize:number=5;
